...
public static class IniHelper
{
    ...
    public static string[] ReadSectionNames(string iniPath)
    {
        ...
        uint bytesReturned = IniHelper.GetPrivateProfileSectionNames(
            pReturnedString,
            MAX_BUFFER,
            iniPath
        );
    ...
    public static string[] ReadAllItems(string iniPath, string section)
    {
        ...
        uint bytesReturned = IniHelper.GetPrivateProfileSection(
            section,
            pReturnedString,
            MAX_BUFFER,
            iniPath
        ...
        if (!(bytesReturned == MAX_BUFFER - 2) || (bytesReturned == 0))
        {
            ...
            items = (
                from item in returnedString.Split(
                    new char[] { '\0' },
    ...
    public static string[] ReadAllItemKeys(string iniPath, string section)
    {
        ...
        uint bytesReturned = IniHelper.GetPrivateProfileString(
            section,
            null,
            null,
            chars,
        ...
        if (bytesReturned != 0)
        {
            // v1.2 modify 2016-10-21 support # remark.
            keys = (
                from key in new string(chars).Split(
                    new char[] { '\0' },
                    StringSplitOptions.RemoveEmptyEntries
                )
    ...
    public static string ReadItemValue(
        string iniPath,
        string section,
        string key,
        string defaultValue = ""
    ...
    public static bool WriteItems(string iniPath, string section, string items)
    {
        ...
        return IniHelper.WritePrivateProfileSection(section, items, iniPath);
    }
    ...
    public static bool WriteValue(string iniPath, string section, string key, string value)
    {
        ...
        return IniHelper.WritePrivateProfileString(section, key, value, iniPath);
    }
    ...
    public static bool DeleteKey(string iniPath, string section, string key)
    {
        ...
        return IniHelper.WritePrivateProfileString(section, key, null, iniPath);
    }
    ...
    public static bool DeleteSection(string iniPath, string section)
    {
        ...
        return IniHelper.WritePrivateProfileString(section, null, null, iniPath);
    }
    ...
    public static bool EmptySection(string iniPath, string section)
    {
        ...
        return IniHelper.WritePrivateProfileSection(section, string.Empty, iniPath);
    }
    ...
    /// <param name="iniFilename"></param>
    /// <returns></returns>
    public static List<string> ReadVals(string SectionName, string iniFilename)
    {
        List<string> result = new List<string>();
        List<string> Keys = ReadKeys(SectionName, iniFilename);
        StringBuilder sb = new StringBuilder(1024);

        for (int i = 0; i < Keys.Count; i++)
        {
            GetPrivateProfileString(SectionName, Keys[i], "", sb, 1024, iniFilename);
