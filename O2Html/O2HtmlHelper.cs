...
public static class O2HtmlHelper
{
    ...
    /// 用默认选项序列化并渲染。
    /// </summary>
    public static void Render(System.Windows.Controls.WebBrowser browser, object? obj)
    {
        Render(
            browser,
            obj,
    ...
    )
    {
        ...
        string fullHtml = WrapWithStyle(bodyHtml);
    ...
    /// </summary>
    public static string WrapWithStyle(string bodyHtml)
    {
        return @"<!DOCTYPE html>
<html lang='zh-CN'>
<head>
<meta charset='UTF-8'>
<style>
  body { font-family: 'Segoe UI', 'Microsoft YaHei', sans-serif; font-size: 13px; margin: 12px; color: #222; }
